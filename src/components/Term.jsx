...
const TermsConditions = () => {
  return (
    <section className="bg-white text-slate-800 mx-auto px-4 py-8">
      <div className="max-w-6xl mx-auto">
        <h1 className="text-3xl font-semibold text-center mb-6 mt-15 text-black">Website Terms of Use</h1>
        <p className="text-center text-slate-500">Last updated: 01/07/26</p>

        <div className="mt-8 space-y-6">
          <section>
            <h2 className="text-2xl font-medium text-black">1. Use of Our Website</h2>
          ...
          <section>
            <h2 className="text-2xl font-medium text-black">2. Accuracy of Information</h2>
            <p className="text-slate-700 mt-1">
          ...
          <section>
            <h2 className="text-2xl font-medium text-black">3. Intellectual Property</h2>
            <p className="text-slate-700 mt-1">
          ...
          <section>
            <h2 className="text-2xl font-medium text-black">4. Links to Other Websites</h2>
            <p className="text-slate-700 mt-1">
          ...
          <section>
            <h2 className="text-2xl font-medium text-black">5. Liability</h2>
            <p className="text-slate-700 mt-1">
          ...
          <section>
            <h2 className="text-2xl font-medium text-black">6. Privacy & Data Protection</h2>
            <p className="text-slate-700 mt-1">
          ...
          <section>
            <h2 className="text-2xl font-medium text-black">7. Changes to These Terms</h2>
            <p className="text-slate-700 mt-1">
          ...
          <section>
            <h2 className="text-2xl font-medium text-black">8. Governing Law</h2>
            <p className="text-slate-700 mt-1">
